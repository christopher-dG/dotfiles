...
;; Font.
(set-frame-font (getenv "EMACS_FONT"))
(set-face-attribute 'default nil :height 120)

;; Themes. Base16 themes tend not to work well on terminals.
(use-package base16-theme)
(let ((theme (if (getenv "EMACS_THEME")
                 (make-symbol (getenv "EMACS_THEME"))
               (if (display-graphic-p) 'base16-embers 'wombat))))
  (load-theme theme t))
